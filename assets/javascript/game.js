...
function museumCollection() {
  ...
  $('#museumCollection').append('<img src="assets/images/' + paintings[randPaint] + '" style="max-height: 200px; max-width:200px;padding:5px;" ><br>');
  museum = paintings[randPaint];
}

//----------Run Functions--------
log("It hits here at Run Functions at the bottom")
startGame();
